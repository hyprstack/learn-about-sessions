...
- Managing server user session with client side single page app: http://stackoverflow.com/questions/21821937/how-to-manage-server-user-session-within-client-side-single-page-app
